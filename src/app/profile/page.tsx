...
import { User, Shield, Heart, Calendar, Settings, LogOut, ChevronRight, Radiation, Fingerprint, Award } from "lucide-react";
            ...
            <main className="pt-24 pb-20 md:pb-20 pb-mobile-nav container mx-auto px-4 max-w-2xl">
                ...
                >
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        {[
                            { icon: "🎖️", label: "First Stay", unlocked: true },
                            { icon: "⭐", label: "5-Star", unlocked: false },
                            { icon: "🏆", label: "Explorer", unlocked: false },
                            ...
                            >
                                ...
                                <div className="text-[10px] text-muted-foreground uppercase">{badge.label}</div>
                            </div>
                        ))}
                    </div>
                </motion.div>
